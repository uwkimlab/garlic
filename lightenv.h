...
extern "C"
{
	...
	void DLLIMPORT  radTrans(int Jday, double tm, double Lati, double Longi, double SolRad0, double LAI, double LAF);
	void DLLIMPORT  radTrans2(int Jday, double tm, double Lati, double Longi, double SolRad0, double PFD0, double LAI, double LAF);
	void DLLIMPORT  setRad(int Jday, double tm, double Lati, double Longi, double SolRad0);

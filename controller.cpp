...
//	char runFile[20] = "Run.dat";
	...
	try
	{
		...
		cfs >> initInfo.cultivar >> initInfo.phyllochron >> initInfo.genericLeafNo >> initInfo.maxLeafLength >> initInfo.maxElongRate >> initInfo.maxLTAR >> initInfo.rLIR >> initInfo.Topt >> initInfo.Tceil >> initInfo.critPPD;
		...
		cout << setiosflags(ios::left)
			...
			<< setw(6)	<< "ratio of leaf initiation rate to LTAR: " << initInfo.rLIR << endl
